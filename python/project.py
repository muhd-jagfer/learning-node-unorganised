...
from learning_unorganised.python.data_entry import get_amount, get_category, get_date, get_description
...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        # coerce parsing errors and drop invalid rows
...
def plot_transactions(df):
    ...
    income_df = df[df["category"] == "Income"]["amount"].resample("D").sum().reindex(idx, fill_value=0)
    expense_df = df[df["category"] == "Expense"]["amount"].resample("D").sum().reindex(idx, fill_value=0)
